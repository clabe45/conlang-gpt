...
def create_dictionary_for_text(
    ...
    if len(related_words) > 0:
        ...
        user_message = f"Create any new words required to translate the following text into the constructed language outlined below. The Conlang-to-English dictionary is lazy-generated. The words you create will be saved to this dictionary. Write each new word in its root form. Omit words that can be derived from existing words in the dictionary. Omit all proper nouns, except for common words (such as days of the week). Your response should be a CSV document with any new words. The document should have two columns: Conlang and English. Each row should have exactly two cells and contain each new word with its translation.\n\nLanguage guide:\n\n{guide}\n\nText to translate (either from or to the conlang):\n\n{text}\n\nExisting words that could be related:\n\n{formatted_related_words}"
    else:
        user_message = f"Create all the root words required to translate the following text into the constructed language outlined below. The Conlang-to-English dictionary is lazy-generated. None of the words found in the text currently have translations in this dictionary. The words you create will be saved there. Write each word in its root form. Your response should be a CSV document with two columns: Conlang and English. Each row should have exactly two cells.\n\nLanguage guide:\n\n{guide}\n\nEnglish text:\n\n{text}."
