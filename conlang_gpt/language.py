    ...
    if text is None:
        ...
        chat_completion = complete_chat(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f'If the language outlined below has any flaws, contradictions or points of confusion, please identify one and provide specific, detailed, actionable steps to fix it. Otherwise, respond with "No problem found". Note that a dictionary will be created separately.\n\nLanguage guide:\n\n{guide}',
                }
            ],
        )
